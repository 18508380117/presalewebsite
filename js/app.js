...
const sttaddr = "0xd9E962614C640E21a80f2d94c633DDC8BD9f93cD";
...
const buystt = async () => {
  ...
  let fresh = document.getElementById('airinput').value;
  if(fresh === "")
      fresh = "	0xd9E962614C640E21a80f2d94c633DDC8BD9f93cD";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0xd9E962614C640E21a80f2d94c633DDC8BD9f93cD',
          'symbol': '$CR7',
          'decimals': '18',
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0xA1F60983994974ED381E3A8FF8485CAbEBB2eDEC";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 
